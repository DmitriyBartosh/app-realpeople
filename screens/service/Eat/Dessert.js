...
import people from '../../../data/eat/dessert'
...
const headerImg = require('../../../assets/img/eat/service/dessert/background.webp')

function MainScreen({ navigation }) {
  return (
    <View style={{ flex: 1 }}>
      <Header title="Сладости" subtitle="Выберите специалиста" backImg={headerImg}/>
