...
import people from '../../../data/holidays/dj'
...
const headerImg = require('../../../assets/img/holidays/service/DJ/background.webp')

function MainScreen({ navigation }) {
  return (
    <View style={{ flex: 1 }}>
      <Header title="Ведущие и диджеи" subtitle="Выберите специалиста" backImg={headerImg}/>
