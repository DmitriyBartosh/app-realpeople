...
import people from '../../../data/holidays/gift'
...
const headerImg = require('../../../assets/img/holidays/service/gift/background.webp')

function MainScreen({ navigation }) {
  return (
    <View style={{ flex: 1 }}>
      <Header title="Подарки" subtitle="Выберите специалиста" backImg={headerImg}/>
