...
import people from '../../../data/holidays/photo'
...
const headerImg = require('../../../assets/img/holidays/service/photo/background.webp')

function MainScreen({ navigation }) {
  return (
    <View style={{ flex: 1 }}>
      <Header title="Фото и видео" subtitle="Выберите специалиста" backImg={headerImg}/>
